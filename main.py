...
styles = [
    ['Landscape', (310, 447), 0.9, 0.6, 250, 0],
    ['Twodogs', (385, 599), 0.95, 0.5, 300, 0],
    ['Arles', (230, 500), 0.9, 0.7, 300, 0],
    ['coast', (700, 420), 0.9, 0.8, 256, 0],
    ['sunday', (900, 650), 0.8, 0.2, 400, 0],
    ['Milkmaid', (1050, 1427), 0.9, 0.2, 300, 0],
    ['reaper', (1150, 1119), 0.9, 0.6, 500, 0],
    ['chamber', (200, 350), 0.9, 0.6, 350, 0],
    ['woman', (200, 300), 0.9, 0.2, 832, 1],
    ['shouter', (80, 500), 0.9, 0.1, 300, 0],
    ['BertheMorisot', (200, 500), 0.8, 0.1, 846, 1]
]
